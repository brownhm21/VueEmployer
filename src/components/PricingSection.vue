                ...
                <v-col class="col-12 col-sm-6 col-md-4">
                  <div class="flex-center">
                    <v-card-text>
                      ...
                      <div class="text-uppercase blue--text">Custom Domains</div>
                      <v-divider class="my-2"/>
                      <div class="text-uppercase blue--text">Limit of 1000 daily hits</div>
                      <v-divider class="my-2"/>
                      <div class="text-uppercase blue--text">Other features...</div>
                      <v-divider class="my-2"/>
                      <div class="text-uppercase text-h4 mt-6 blue--text">20,00 MAD</div>
                      <v-btn
                          v-bind="size"
                          rounded
                          outlined
                ...
                <v-col class="col-12 col-sm-6 col-md-4">
                  <div class="flex-center">
                    <v-card-text>
                      ...
                      <div class="text--disabled text-uppercase text-h5 my-2">Pattern</div>
                      <v-divider class="my-2"/>
                      <div class="text-uppercase blue--text">Custom Domains</div>
                      <v-divider class="my-2"/>
                      <div class="text-uppercase blue--text">Limit of 1000 daily hits</div>
                      ...
                      <div class="text-uppercase blue--text">Other features...</div>
                      <v-divider class="my-2"/>
                      <div class="text-uppercase text-h4 mt-6 blue--text">100,00 MAD</div>
                      <v-btn
                          v-bind="size"
                          rounded
                          outlined
                ...
                <v-col class="col-12 col-md-4">
                  ...
                  <div class="flex-center">
                    <v-card-text>
                      ...
                      <div class="text-uppercase blue--text">Custom Domains</div>
                      <v-divider class="my-2"/>
                      <div class="text-uppercase blue--text">Unlimited Access</div>
                      <v-divider class="my-2"/>
                      <div class="text-uppercase blue--text">Other features...</div>
                      <v-divider class="my-2"/>
                      <div class="text-uppercase text-h4 mt-6 blue--text">500,00 MAD</div>
                      <v-btn
                          v-bind="size"
                          rounded
                          outlined
